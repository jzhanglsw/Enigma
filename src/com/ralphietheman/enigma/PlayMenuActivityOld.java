...
import com.ralphietheman.enigma.PuzzleSelectActivity.Puzzle;

public class PlayMenuActivityOld extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.play_menu_activity_old, menu);
		return true;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try 
		{
			puzzlesOld = parseOld(getAssets().open(newpuzzlepack));
            	...
            	if(puzzlenum<=puzzles.size())
            	{
                    ...
                    b.setOnClickListener(new OnClickListener(){
                    	public void onClick(View v){
                    		...
                    		//Not yet implemented
                    		Intent intent = new Intent(PlayMenuActivityOld.this, PuzzleActivityOld.class);
                    		if(puzzles != null)
                    		{
                    			int puzzlenum = v.getId();
                    			Puzzle1 move = puzzlesOld.get(puzzlenum-1);
